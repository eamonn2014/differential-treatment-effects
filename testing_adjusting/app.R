...
# https://stats.stackexchange.com/questions/154926/mean-centering-before-regression-or-observations-that-enter-regression
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
rm(list=ls())   
                    ...
                    sidebarPanel( width=3 ,
                                  ...
                                  div(
                                      ...
                                      selectInput("Design",
                                                  ...
                                                  choices=c(  "Treatment interacts with all variables" ,"No-interaction logit-additive model", 
...
server <- shinyServer(function(input, output   ) {
    ...
    output$textWithNumber99 <- renderText({ 
        ...
        HTML(paste0(  tags$hr(),
                      # "Treatment: 1 smoking 2 vrs smoking 1 log odds "  
                      ...
                      # 
                      # 
                      # ". Treatment 2 smoking 2 vrs smoking 1 log odds "  
                      # , tags$span(style="color:red",  
                      #             p4(  (coef(A)['trt=2'])+( coef(A)['trt=2 * smoking=2'] ))
                      #             ),
                      # 
                      # 
                      # ". Coefficients "  
                      ...
                      "In smokers factor level 1 what's the treatment effect: "  
                      , tags$span(style="color:red",  
                                  p4(  coef(A)['smoking=2'])  
